...
public final class Utils {
     ...
     */
    public static Random rnd = new Random(ThreadLocalRandom.current().nextLong());
    ...
    {
        return World.getInstance().getAllEntities().stream()
     ...
     */
    public static Direction getRelativeDirection(final IVec2 p1, final IVec2 p2)
    {
        if (p1.x == p2.x)
        {
            if (p1.y < p2.y)
